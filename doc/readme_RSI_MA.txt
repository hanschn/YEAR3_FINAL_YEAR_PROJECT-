...
#     if RSI(-1) >= 50, RSI(-1) > RSI(0), EMA(10) < EMA(25) go short
#     if EMA(10) > EMA(25), exit
# The strategy will go long：
#     if RSI(1) <= 50, RSI(-1) < RSI(0), EMA(10) > EMA(25) go long
#     if EMA(10) < EMA(25), exit
# and will be flat otherwise

3.策略参数
###  parameters for strategy ### 
# rsi_period: period to calculate RSI (default is 14)
# rsi_threshold: threshold to compare the RSI (default is 50)
# ema_long: long period of EMA(default is 10)
# ema_short: short period of EMA(default is 25)
# ratio: max ratio of balance usage, "0.5" means only use 50% of total capital(default is 0.3)
